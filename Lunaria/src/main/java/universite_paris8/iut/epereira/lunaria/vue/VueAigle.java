...
public class VueAigle extends VueActeur{
    private Image[] ennemiFrames;

    public VueAigle(Ennemi ennemi, Controleur controleur) {
    ...
    protected void prechargerImages() {
        ...
        ennemiFrames[0] = new Image(getClass().getResourceAsStream("/universite_paris8/iut/epereira/lunaria/DossierMap/Aigle/aigle.png"));
    }
    ...
    protected ImageView creerSprite() {
        ...
        animation.play();
        stockerAnimation("aigle", animation);
